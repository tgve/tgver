---
title: "Interactive geospatial processing and visualization gwith TGVE"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Interactive geospatial processing and visualization gwith TGVE}
...
The aim of this vignette is to show the way TGVE has been developed and showcase the difference between this approach and other approaches where R is used to generate HTML, CSS and/or JavaScript (JS) code to generate visualizations to run browsers. Although the front-end application is written in ReactJS, the `tgver` package bundles a production build of a web application that uses the `@tgve/tgvejs` npm package.
